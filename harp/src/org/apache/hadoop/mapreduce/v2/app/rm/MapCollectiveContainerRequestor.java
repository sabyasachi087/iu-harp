...
import org.apache.hadoop.mapreduce.v2.app.MapCollectiveAppMaster.RunningAppContext;
...
/**
 * This class is modified from RMContainerRequestor.
 * unregister and doUnregistration are re-written from RMCommunicator
 * because RunningContext is changed in MapCollectiveContainerLauncherImpl.
 * 
 * The following is the original document:
 * 
 * Keeps the data structures to send container requests to RM.
 */
public abstract class MapCollectiveContainerRequestor extends RMCommunicator {

  private static final Log LOG = LogFactory
    .getLog(MapCollectiveContainerRequestor.class);
  ...
  public MapCollectiveContainerRequestor(ClientService clientService,
    AppContext context) {
  ...
  static class ContainerRequest {
    ...
    public ContainerRequest(ContainerRequestEvent event, Priority priority) {
      this(event.getAttemptID(), event.getCapability(), event.getHosts(), event
        .getRacks(), priority);
    }
  ...
  protected void serviceInit(Configuration conf) throws Exception {
    ...
    rmPollInterval = conf.getInt(MRJobConfig.MR_AM_TO_RM_HEARTBEAT_INTERVAL_MS,
  ...
  protected void computeIgnoreBlacklisting() {
    ...
    if (blacklistDisablePercent != -1
      && (blacklistedNodeCount != blacklistedNodes.size() || clusterNmCount != lastClusterNmCount)) {
  ...
  private void addResourceRequest(Priority priority, String resourceName,
    ...
    LOG.info("addResourceRequest:" + " applicationId=" + applicationId.getId()
      ...
      + ask.size() + " capacity=" + remoteRequest.getCapability());
  }
  ...
  protected void unregister() {
    try {
      ...
      RunningAppContext raContext = (RunningAppContext) getContext();
      raContext.computeIsLastAMRetry();
    }
  }

  protected void doUnregistration() throws YarnException, IOException,
    InterruptedException {
    FinalApplicationStatus finishState = FinalApplicationStatus.UNDEFINED;
    JobImpl jobImpl = (JobImpl) getJob();
