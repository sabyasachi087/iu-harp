 ...
 * 
 * This code is modified from Long2ObjectOpenHashMap in fastutil-6.5.15
 * 
 * @author zhangbj
 * 
 * @see Hash
 * @see HashCommon
 */
public class Long2ObjectReuseHashMap<V> extends AbstractLong2ObjectMap<V>
  ...
  public Long2ObjectReuseHashMap(final int expected, final float f,
    Class<V> vClass) {
    if (f <= 0 || f > 1)
   ...
   */
  public Long2ObjectReuseHashMap(final int expected, Class<V> vClass) {
   ...
   */
  public Long2ObjectReuseHashMap(Class<V> vClass) {
   ...
   * @param f the load factor.
   */
  public Long2ObjectReuseHashMap(final Map<? extends Long, ? extends V> m,
   ...
   * @param f the load factor.
   */
  public Long2ObjectReuseHashMap(final Long2ObjectMap<V> m, final float f,
    Class<V> vClass) {
    this(m.size(), f, vClass);
    putAll(m);
  }
   ...
   * @param m a type-specific map to be copied into the new hash map.
   */
  public Long2ObjectReuseHashMap(final Long2ObjectMap<V> m, Class<V> vClass) {
    this(m, DEFAULT_LOAD_FACTOR, vClass);
  }
   ...
   *           different lengths.
   */
  public Long2ObjectReuseHashMap(final long[] k, final V v[], final float f,
    Class<V> vClass) {
   ...
   *           different lengths.
   */
  public Long2ObjectReuseHashMap(final long[] k, final V v[], Class<V> vClass) {
  ...
  private class MapIterator {
     ...
     */
    int pos = Long2ObjectReuseHashMap.this.n;
    /**
    ...
    {
      final boolean used[] = Long2ObjectReuseHashMap.this.used;
      if (c != 0)
        while (!used[--pos])
          ;
    }
    ...
    public void remove() {
      ...
      if (pos < -1) {
        ...
        Long2ObjectReuseHashMap.this.remove(wrapped.getLong(-pos - 2));
        last = -1;
        return;
      }
      size--;
  ...
  private class FastEntryIterator extends MapIterator implements
    ObjectIterator<Long2ObjectMap.Entry<V>> {
    final edu.iu.harp.util.LongBasicEntry<V> entry = new edu.iu.harp.util.LongBasicEntry<V>(
      ((long) 0), (null));

    public edu.iu.harp.util.LongBasicEntry<V> next() {
  ...
  private final class MapEntrySet extends
    ...
    public boolean remove(final Object o) {
      ...
      while (used[pos]) {
        if (((key[pos]) == (k))) {
          Long2ObjectReuseHashMap.this.remove(e.getKey());
          return true;
        }
        pos = (pos + 1) & mask;
      }
    ...
    public void clear() {
      Long2ObjectReuseHashMap.this.clear();
    }
  }
  ...
  private final class KeySet extends AbstractLongSet {
    ...
    public boolean remove(long k) {
      ...
      Long2ObjectReuseHashMap.this.remove(k);
      return size != oldSize;
    }
  ...
  protected void rehash(final int newN) {
    ...
    // This is also modified to use Array.newInstance
   ...
   */
  @SuppressWarnings("unchecked")
  public Long2ObjectReuseHashMap<V> clone() {
    Long2ObjectReuseHashMap<V> c;
    try {
      c = (Long2ObjectReuseHashMap<V>) super.clone();
