...
public class WritableObjReqHandler extends ByteArrReqHandler {
  /** Class logger */
  private static final Logger LOG = Logger
    .getLogger(WritableObjReqHandler.class);

  public WritableObjReqHandler(WorkerData workerData, ResourcePool pool,
    Connection conn) {
