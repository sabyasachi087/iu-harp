...
public class DataGen {
  ...
  static void generateInputData(int numMappers, String localDirName,
    Path inputDirPath, FileSystem fs) throws IOException, InterruptedException,
    ExecutionException {
  ...
  static void generateData(int numMappers, Path inputDirPath,
    String localDirName, FileSystem fs) throws IOException,
    InterruptedException, ExecutionException {
    generateInputData(numMappers, localDirName, inputDirPath, fs);
  }
}
