...
public class DataGenRunnable implements Runnable {
  ...
  public DataGenRunnable(int pointsPerFile, String localInputDir, String fileName,
    int vectorSize) {
  ...
  public void run() {
    ...
    try {
      DataOutputStream out = new DataOutputStream(new FileOutputStream(
        this.localDir + File.separator + "data_" + this.fileName));
      ...
      out.close();
      System.out.println("Done written file " + this.fileName);
